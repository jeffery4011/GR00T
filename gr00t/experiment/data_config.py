...
###########################################################################################
class XarmDualDataConfig(BaseDataConfig):
    video_keys = [
    ...
    observation_indices = [0] # Observation steps
    action_indices = list(range(16)) # Action steps
...
DATA_CONFIG_MAP = {
    ...
    "new_embodiment": XarmDualDataConfig(),
    "new_embodiment_joint": XarmDualJointDataConfig(),
    "new_embodiment_pos": XarmDualPosDataConfig(),
}
